...
<div style="padding:8px 0 4px;">
  ...
  <div style="font-family:'Montserrat',sans-serif;font-size:52px;font-weight:900;line-height:1.05;letter-spacing:-.02em;text-transform:uppercase;">Ticket Page Generator</div>
...
_TICKET_CSS = (
    ...
    '.ticket-note{font-size:18px;color:#555;margin-bottom:24px;font-weight:700;}\n'
    ...
    '.ticketType{grid-column:1/span 2;grid-row:1;text-align:left;font-size:15px;font-weight:800;letter-spacing:.08em;opacity:1;padding-bottom:7px;border-bottom:1px solid rgba(255,255,255,0.22);}\n'
    ...
    '.ticket-notice{list-style:none;padding:0;margin:24px auto;max-width:540px;font-size:14px;text-align:left;font-weight:700;}\n'
...
_TICKET_CSS_T2 = (
    ...
    '.an-snav{position:sticky;top:0;z-index:200;background:rgba(11,29,64,.93);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);}\n'
    '.an-snav-inner{display:flex;align-items:center;justify-content:space-between;max-width:820px;margin:0 auto;padding:0 16px;}\n'
    '.an-snav-links{display:flex;}\n'
    '.an-snav-link{display:inline-flex;align-items:center;padding:14px 22px;color:rgba(255,255,255,.45);font-family:"Montserrat",sans-serif;font-weight:800;font-size:12px;letter-spacing:.2em;text-decoration:none;border-bottom:3px solid transparent;transition:color .2s,border-color .2s;-webkit-tap-highlight-color:transparent;}\n'
    '.an-snav-link.is-active{color:#fff;border-bottom-color:#d49a31;}\n'
    '.an-snav-cta{display:inline-block;padding:8px 24px;background:#d49a31;color:#0b1d40;font-family:"Montserrat",sans-serif;font-weight:800;font-size:12px;letter-spacing:.06em;border-radius:4px;text-decoration:none;white-space:nowrap;}\n'
    '.an-snav-cta:hover{background:#e0aa45;color:#0b1d40;}\n'
    '@media(max-width:480px){.an-snav-link{padding:12px 14px;font-size:11px;letter-spacing:.14em;}.an-snav-cta{padding:7px 14px;font-size:11px;}}\n'
    ...
    '.an-ticketType{grid-column:1/span 2;grid-row:1;text-align:left;font-size:15px;font-weight:800;letter-spacing:.08em;opacity:.9;padding-bottom:7px;border-bottom:1px solid rgba(0,0,0,.1);}\n'
...
def _generate_html_t2(data, orig_data, lang='ja'):
    ...
    notice_section = (
        '<section id="ant-notice" class="an-notice-section">'
    ...
    html_out = (
        ...
        '<div id="AN2026">\n'
        + hero_html + '\n'
        + '<nav class="an-snav" id="an-sticky-nav">'
        + '<div class="an-snav-inner">'
        + '<div class="an-snav-links">'
        + '<a class="an-snav-link is-active" href="#ant-tickets" data-target="ant-tickets">TICKET</a>'
        + '<a class="an-snav-link" href="#ant-notice" data-target="ant-notice">NOTICE</a>'
        + '</div>'
        + '<a class="an-snav-cta" href="#ant-tickets">チケット購入はこちら</a>'
        + '</div></nav>\n'
        + lineup_html + '\n'
        + tickets_section + '\n'
        + sched_section + '\n'
        ...
        + '<script>\n'
        + '(function(){\n'
        + '  var links=document.querySelectorAll(".an-snav-link");\n'
        + '  var ids=["ant-tickets","ant-notice"];\n'
        + '  var sections=ids.map(function(id){return document.getElementById(id);}).filter(Boolean);\n'
        ...
        + '      if(target){\n'
        + '        var navH=document.getElementById("an-sticky-nav").offsetHeight;\n'
        + '        var top=target.getBoundingClientRect().top+window.scrollY-navH-8;\n'
        + '        window.scrollTo({top:top,behavior:"smooth"});\n'
        + '      }\n'
        + '    });\n'
